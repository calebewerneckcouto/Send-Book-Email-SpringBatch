...
public class SendEmailUserStepConfig {
	...
	@Bean
	public Step sendEmailUserStep(ItemReader<UserBookLoan>readUsersWithLoanCloserToReturnReader, 
			ItemWriter<UserBookLoan>sendEmailRequestReturnWritter,			
			JobRepository jobRepository) {
             return new StepBuilder("sendEmailUserStep", jobRepository)
            		...
            		.writer(sendEmailRequestReturnWritter)
            		.build();
	}
}
